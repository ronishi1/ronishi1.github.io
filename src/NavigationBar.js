  ...
  return (
    <Navbar bg="light" variant="light">
      <Container style={{width:"76.5%"}}>
        <Navbar.Brand className="brand-font" href="/">Ray Onishi</Navbar.Brand>
        <Nav className="ml-auto">
          <Nav.Link style={{fontSize:"1.10rem"}} as={Link} to="/projects" >Projects</Nav.Link>
          <Nav.Link style={{fontSize:"1.10rem"}} href="resume.pdf">Resume</Nav.Link>
