    ...
    <div className="App">
      <Navbar bg="light" variant="light">
        <Container style={{width:"76%"}}>
          <Navbar.Brand href="#home">Ray Onishi</Navbar.Brand>
